...
class _CountryCodePickerState extends State<CustomPhoneNumberInput> {
  ...
  String? _validatePhoneNumber(String? value) {
    if (widget.isMandatory == false && (value == null || value.isEmpty)) {
      return null;
    } else if (widget.isMandatory == false && (value?.length != 9)) {
      return '     Number should be 9 characters';
    }
    return null;
  }
              ...
              children: [
                Directionality(
                  ...
                  child: TextFormField(
                    ...
                    validator: widget.isMandatory ?_phoneNumberInputController.validator : _validatePhoneNumber,
